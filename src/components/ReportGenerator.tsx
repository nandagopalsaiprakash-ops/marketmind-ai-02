  ...
  return (
    <div className="p-4 md:p-6 space-y-6 overflow-y-auto h-full">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="font-display font-bold text-xl md:text-2xl text-foreground">Marketing Report</h2>
          <p className="text-sm text-muted-foreground mt-1">Generate comprehensive marketing reports with PDF export</p>
        </div>
      ...
      <AnimatePresence>
        {report && (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-4">
            <div className="flex items-center justify-between">
              <h3 className="font-display font-semibold text-foreground">Your Report</h3>
              <button
                onClick={downloadPdf}
                className="flex items-center gap-2 px-4 py-2 rounded-lg gradient-accent text-accent-foreground text-sm font-medium hover:shadow-glow transition-all"
              >
                <Download className="w-4 h-4" />
                Download PDF
              </button>
            </div>
            <div className="bg-card border border-border rounded-xl p-5 prose prose-sm prose-invert max-w-none [&_h1]:font-display [&_h1]:text-lg [&_h1]:text-foreground [&_h2]:font-display [&_h2]:text-base [&_h2]:text-foreground [&_h3]:font-display [&_h3]:text-sm [&_h3]:text-foreground [&_p]:text-secondary-foreground [&_p]:text-sm [&_p]:leading-relaxed [&_li]:text-secondary-foreground [&_li]:text-sm [&_strong]:text-foreground">
